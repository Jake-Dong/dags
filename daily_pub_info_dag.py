...
def lv2_fun(Lv_1_cpc): #lv2 구해주는 함수.
    cpc_lv1_all = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'Y']

    cpc_lv2_A = ['A01', 'A21', 'A22', 'A23', 'A24', 'A41', 'A42', 'A43', 'A44', 'A45', 'A46', 'A47', 'A61', 'A62', 'A63', 'A99']
    cpc_lv2_B = ['B01', 'B02', 'B03', 'B04', 'B05', 'B06', 'B07', 'B08', 'B09', 'B21', 'B22', 'B23', 'B24', 'B25', 'B26', 'B27', 'B28', 'B29', 'B30', 'B31', 'B32', 'B33', 'B41', 'B42', 'B43', 'B44', 'B60', 'B61', 'B62', 'B63', 'B64', 'B65', 'B66', 'B67', 'B68', 'B81', 'B82', 'B99']
    cpc_lv2_C = ['C01', 'C02', 'C03', 'C04', 'C05', 'C06', 'C07', 'C08', 'C09', 'C10', 'C11', 'C12', 'C13', 'C14', 'C21', 'C22', 'C23', 'C25', 'C30', 'C40', 'C99']
    cpc_lv2_D = ['D01', 'D02', 'D03', 'D04', 'D05', 'D06', 'D07', 'D10', 'D21', 'D99']
    cpc_lv2_E = ['E01', 'E02', 'E03', 'E04', 'E05', 'E06', 'E21']
    cpc_lv2_F = ['F01', 'F02', 'F03', 'F04', 'F05', 'F15', 'F16', 'F17', 'F21', 'F22', 'F23', 'F24', 'F25', 'F26', 'F27', 'F28', 'F41', 'F42', 'F99']
    cpc_lv2_G = ['G01', 'G02', 'G03', 'G04', 'G05', 'G06', 'G07', 'G08', 'G09', 'G10', 'G11', 'G12', 'G16', 'G21', 'G99']
    cpc_lv2_H = ['H01', 'H02', 'H03', 'H04', 'H05', 'H99']
    cpc_lv2_Y = ['Y02', 'Y04', 'Y10']

    cpc_lv3_all = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'V', 'W', 'Y', 'Z']
...
def pub_num_db():
    ...
    for date in dt_list:
        try:
            ...
            cur = conn.cursor()
            sql = """CREATE TABLE test.pub_num_data_{} (family_id varchar(200),pub_country varchar(200),pub_doc_number varchar(200),pub_kind_code varchar(200),docdb_pub_num varchar(200));""".format(
                date)
            cur.execute(sql)
            conn.commit()
